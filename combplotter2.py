...
fname1 = ('trdata-7-20-11-24-12.csv')
pathname1 = ('/home/starshipcrew/results/noadvice/')


fname2 = ('trdata-7-20-11-19-16.csv')
pathname2 = ('/home/starshipcrew/results/singleadvice/')


fname3 = ('trdata-7-20-11-21-27.csv')
...
print (len(runningavg1),len(runningavg2),len(runningavg3))

plt.figure(1)

plt.subplot(211)
#plt.plot(avgepisode, avg1 , 'b-',avgepisode, avg2 , 'k-',avgepisode, avg3, 'r-', linewidth = 0.8)
plt.plot(avgepisode, avg1, 'b-', linewidth = 0.8, label = 'No advice')
plt.plot(avgepisode, avg2, 'k-', linewidth = 0.8, label = 'Single advice')
...
plt.axis([0, len(epi1), -600,0 ])
plt.grid(True)
plt.legend()

plt.subplot(212)
#plt.plot(avgepisode, runningavg1 , 'b-',avgepisode, runningavg2 , 'k-',avgepisode, runningavg3, 'r-',linewidth = 0.8)
plt.plot(avgepisode, runningavg1, 'b-', linewidth = 0.8, label = 'No advice')
plt.plot(avgepisode, runningavg2, 'k-', linewidth = 0.8, label = 'Single advice')
