...
class AgentState:
    ...
    def directionToVector(direction, speed = 1.0):
        dx, dy =  AgentState._directions[direction]
    ...
    def getLegalNeighbors(position, walls):
        ...
        neighbors = []
        for dir, vec in AgentState._directionsAsList:
            dx, dy = vec
            next_x = x_int + dx
...
class Actions:
    ...
    """
    def getAllActions(config, walls): #def added  by me 
        possible = []
        x, y = config.pos
        x_int, y_int = int(x + 0.5), int(y + 0.5)
...
class Game:
    ...
    def run( self ):
        """
        Main control loop for game play.##################################learning here##########
        """
